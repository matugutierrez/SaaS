  ...
  return (
    <a href={`/projects/${doc.project}/wiki/${doc._id}`}
      ...
      <div className="flex items-start gap-3 mb-3">
        <div className="w-9 h-9 bg-muted text-text-secondary flex items-center justify-center flex-shrink-0">
      ...
      <div className="flex items-center justify-between text-text-secondary text-xs pt-3 border-t border-border-light">
        <span className="bg-muted text-text-secondary px-2 py-0.5">v{doc.version}</span>
